...
import { DynamoDBClient, DynamoDBClientConfig, QueryCommandInput } from "@aws-sdk/client-dynamodb";
...
export class DynamoService2 implements DbService {
    ...
    public getItem = async (table: string, query: any) => {
        ...
        if (indexMatches.length > 0) {
            ...
            command.KeyConditionExpression = DynamoService2.buildScanExpression(query)
        } else {
